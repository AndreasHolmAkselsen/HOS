    ...
    case 'hos'
        ...
        switch nwt.sim.type
            case 'periodicDomain2D'
                ...
                %Perform time-integration
                options=odeset('RelTol',nwt.solver.rTol,'InitialStep',nwt.solver.initialStepODE);
                switch nwt.solver.ramp.type
                    case 'exp'
                        TRamp=nwt.solver.ramp.Ta;
                        nRamp=nwt.solver.ramp.n;
                        [t,Y]=ode45(@(t,y)detaPhiS_dt_ExpRamp(t,y,k,M,h,HLP,TRamp,nRamp,nwt.curr.df,nwt.solver.deAliasingProductOrder),returnTimes,y0,options);
                    otherwise
