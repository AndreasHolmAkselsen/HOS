function [h_fig, h_ax] = multi_axes(n,m,h_fig,margin,sep)
% creates an n x m array of axes with specified dimensions in a figure.

% multi_axes(n, m, h_fig, margin, sep), 
% margin = [xLeft, xRight, yBottom, yTop], 
% sep = [sep_x,sep_y]
