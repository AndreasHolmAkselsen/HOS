...
\begin{figure}[h!ptb]%
\centering
\subfloat[Vortex current]{\includegraphics[width=.5\columnwidth]{../conformalMapping/conformalHOS_current/figures/curr_vortex.pdf}}%
\\
\subfloat[Benchmark; \eqref{eq:BCb} vs.\ \eqref{eq:BCb_normalHos}.]{\includegraphics[width=\columnwidth]{../conformalMapping/conformalHOS_current/figures/vortex.pdf}}%
