...
%\usepackage{hyperref}
%\usepackage{enumitem}
%%\usepackage{cprotect} % \cprotect\caption{\verb|#1|}%
...
Similar to \autoref{fig:45degDeep_H1p0_0p1_ka0p05_nw10_np10} to \ref{fig:1deg_H1p0_0p3_ka0p05_nw10_np10}, we also consider in \autoref{fig:downStrepRefl45degDeep_H0p1_1p0_ka0p05_nw5_np5} to \ref{fig:downStrepRefl1deg_H0p1_0p3_1p0_ka0p05_nw3_np3} the effect of down-sloping depth transitions.
...
\triIm{downStrepRefl4p5deg_H0p1_0p3_1p0_ka0p05_nw4_np4}{Reflected wave from from 4.5\textdegree{} down-sloap, abruptly increasing after depth $0.15\lambda$. $h\_s/\lambda\_d =0.05$, $(ka)\_d = 0.05$.}
\triIm{downStrepRefl2deg_H0p1_0p3_1p0_ka0p05_nw3_np3}{Reflected wave from from 2.0\textdegree{} down-sloap, abruptly increasing after depth $0.15\lambda$. $h\_s/\lambda\_d =0.05$, $(ka)\_d = 0.05$.}
\triIm{downStrepRefl1deg_H0p1_0p3_1p0_ka0p05_nw3_np3}{Reflected wave from from 1.0\textdegree{} down-sloap, abruptly increasing after depth $0.15\lambda$. $h\_s/\lambda\_d =0.05$, $(ka)\_d = 0.05$.}
